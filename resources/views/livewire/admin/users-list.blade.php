<div class="mb-3">
    ...
    <div class="users-container mb-3">
        ...
        <livewire:admin.user-details :user="$user" wire:key="user-details-{{ $user->id }}"/>
        <livewire:admin.user-edit :user="$user" wire:key="user-edit-{{ $user->id }}"/>
        <livewire:admin.user-status :user="$user" wire:key="user-status-{{ $user->id }}" />
        @empty
